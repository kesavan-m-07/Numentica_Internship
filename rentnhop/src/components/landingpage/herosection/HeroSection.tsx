...
const HeroSection = () => {
  ...
  return (
    <div className=' flex flex-col-reverse md:flex-row bg-no-repeat bg-contain bg-[position:0_-100px] md:bg-[url("/heroSectionBackground.png")] md:min-h-[50vh] lg:min-h-[90vh] overflow-hidden '>
