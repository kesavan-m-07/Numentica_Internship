...
const ServiceBanner = () => {
  return (
    <section className="flex flex-col md:flex-row  justify-between items-center overflow-hidden mx-2 my-5 py-4 md:py-6 rounded-2xl bg-gradient-to-b from-[#0056F1]/20 to-white/20 cursor-pointer">
      <img
        src={ActivaPng}
        alt="Bike"
        loading="lazy"
