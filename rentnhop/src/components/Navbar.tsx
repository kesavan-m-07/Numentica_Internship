...
const Navbar = ({ showOnMobile = false, flexCol = false }: { showOnMobile?: boolean; flexCol?: boolean }) => {
  ...
  return (
    <nav
      className={`${baseLayout} ${direction} justify-between gap-4 mx-4 lg:gap-7 lg:ml-4 `}
    >
      {navItems.map((item, i) => (
        <NavLink
          to={item.linkTo}
